...
export default function PreventiveCampaignsServices(): JSX.Element {
  ...
  const campaigns = [
    ...
    {
      image: "/svgs/reprogramacion-ecu-frenos-lc300-y-rav4.svg",
      title: "Reprogramación ECU frenos LC300 (FJA300, VJA300) y RAV4",
      description:
        "Esta CAMPAÑA DE SEGURIDAD Toyota aplica para los vehículos indicados, los cuales están equipados con un sistema de control de estabilidad del vehículo (VSC) que es operado por una ECU de control de derrape con una lógica de software específica. Debido a una programación incorrecta del software Skid Control ECU, después de un conjunto particular de entradas operativas en las que el conductor apaga manualmente el VSC mediante el control del VSC en el vehículo y el encendido se apaga y luego se vuelve a encender mientras el pedal del freno está continuamente presionado, el VSC no regresará a la configuración predeterminada de ENCENDIDO en el siguiente ciclo de encendido. Esta condición puede resultar en un incumplimiento de las regulaciones aplicables en algunos países. A menos que se sigan estas entradas de operación precisas, la operación de VSC volverá automáticamente a la configuración predeterminada de VSC ON en cualquier ciclo de encendido posterior. Si el VSC no está predeterminado en VSC ON, se encenderá una luz de advertencia para indicarle al conductor que el VSC no está activado. Si el VSC no regresa a la configuración predeterminada de ENCENDIDO porque se realizaron las entradas de operación precisas y el conductor tampoco reconoce la luz de advertencia para reactivar manualmente el sistema VSC, entonces operar el vehículo con un sistema VSC inoperante podría aumentar el riesgo de un choque en ciertas condiciones de manejo. Se reprograma la ECU de frenos.",
    },
    {
      image: "/svgs/reprogramacion-ecu-transmision.svg",
      title:
        "Reprogramación ECU transmisión LC300 (VJA300, FJA300) y Tundra (VXKA76, VXKH76)",
      description:
        "El conjunto de transmisión en los vehículos involucrados utiliza un pistón de embrague para acoplar los discos del embrague de freno a los platos para transferir potencia del motor a las ruedas. Existe la posibilidad de que, debido a un problema en el diseño de un determinado disco de embrague de freno, cuando la transmisión se cambia a la posición N y se elimina la presión del pistón del embrague, los discos de embrague de freno no se desacoplen inmediatamente de los platos, permitiendo que parte de la potencia del motor continúe transfiriéndose a las ruedas. Si esta condición ocurre cuando el vehículo está sobre una superficie plana y si el conductor no aplica el freno de pedal o el freno de estacionamiento, podría permitir que el vehículo avance lentamente inadvertidamente a baja velocidad (hasta aproximadamente 4 mph). lo que podría aumentar el riesgo de un accidente.",
    },
    {
      image: "/svgs/reprogramacion-ecu-motor.svg",
      title: "Reprogramación ECU motor Corolla (ZRE17)",
      description:
        "Debido a una incorrecta reprogramación de la ECU de motor, el  conductor puede experimentar una sacudida anormal mientras el vehículo está estático en la posición D de la palanca de cambios.",
    },
    {
      image: "/svgs/reprogramacion-ecu-motor.svg",
      title: "Reprogramación motor Hilux y Fortuner (GUN125, GUN165)",
      description:
        "Los conductores pueden experimentar una condición de inestabilidad en el motor durante una condición de operación normal del vehículo.",
    },
    {
      image: "/svgs/retiro-reemplazo-barra-deportiva.svg",
      title: "Retiro y reemplazo barra deportiva Hilux (Hilux GR, GUN126)",
      description:
        "Los vehículos indicados están equipados con una barra deportiva. En condiciones de uso extremas, los soportes de la barra deportiva pueden agrietarse. Si esto ocurre, podría resultar peligroso para otros vehículos y representar un riesgo para la seguridad del tráfico peatonal.",
    },
    {
      image: "/svgs/tapa-combustible-lc70.svg",
      title: "Tapa de combustible LC70 (GRJ79)",
      description:
        "Los vehículos involucrados están equipados con un tanque de combustible que se conforma con un tubo de llenado de combustible ubicado en el exterior del vehículo. Debido a especificaciones incorrectas del vehículo, existe la posibilidad de que estos vehículos no tengan la tapa de combustible sin mecanismo de bloqueo. En esta condición, el vehículo no cumple con determinada normativa.",
    },
    {
      image: "/svgs/reprogramacion-ecu-motor.svg",
      title: "Reemplazo motores LC300 (VJA300)",
      description:
        "Los vehículos indicados están equipados con un motor V35A específico que contiene cojinetes principales del cigüeñal que permiten que el cigüeñal gire dentro del conjunto del motor mientras está en funcionamiento. Durante un período de producción específico, existe la posibilidad de que los desechos de mecanizado del motor de un tamaño y cantidad particulares no se hayan eliminado del motor durante la fabricación y, posteriormente, contaminen el ensamblaje del motor durante el proceso de producción. En el caso de estos motores en los vehículos relacionados, la presión sobre los rodamientos principales debido a la configuración del motor es tal que, si los residuos de mecanizado antes mencionados se adhieren a los rodamientos y el funcionamiento del motor continúa con cargas más altas a lo largo del tiempo, puede producirse un fallo de los rodamientos. Esto puede provocar posibles golpeteos en el motor, un funcionamiento brusco del motor, falta de arranque del motor y/o un bloqueo del motor. En los vehículos indicados, una parada del motor durante la conducción conduce a una pérdida de potencia motriz. La pérdida de potencia motriz del vehículo mientras se conduce a velocidades más altas puede aumentar el riesgo de un choque.",
    },
    {
      image: "/svgs/reemplazo-ejes-delanteros-corolla-cross.svg",
      title: "Reemplazo ejes delanteros Corolla Cross (ZVG10, MXGA10)",
      description:
        "Los vehículos indicados están equipados con dos ejes de transmisión delanteros que transmiten fuerza motriz a las ruedas delanteras. Durante el proceso de montaje del eje de transmisión, la grasa se había adherido a la sección de fijación de la tuerca de seguridad del eje de transmisión, lo que provocó que la fuerza axial al apretar la tuerca de seguridad fuera mayor de lo esperado.\n\n Si el vehículo equipado con un eje de transmisión afectado se opera repetidamente aplicando un par mayor a los ejes de transmisión delanteros, el eje de transmisión afectado podría fracturarse, lo que provocaría una pérdida de fuerza motriz y aumentaría el riesgo de un choque.\n\n En esta campaña de seguridad, Toyota realizará el reemplazo de los ejes delanteros izquierdo y derecho.",
    },
  ];

  const calculateColumns = () => {
    const containerWidth = Math.min(window.innerWidth * 0.95, 1530);
    const colWidth = 290; // card width
    return Math.floor(containerWidth / colWidth);
  };
  ...
  const calculateVisibleCount = () => {
    if (window.innerWidth >= 1280) {
      ...
      return cols * rows; // e.g. 5 * 2 = 10
    } else {
      // Mobile & Tablet → 5 rows × 2 columns
      const cols = 2;
      const rows = 5;
      return cols * rows; // 2 * 5 = 10    }
    }
  };
    ...
    <View>
      ...
      >
        <Heading
          ...
          margin={{ base: "50px 0px 24px", xl: "110px 0px 52px" }}
          maxWidth={{ base: "56%", medium: "37%", xl: "" }}
          // maxWidth={{ xl: "17ch" }}
        >
        ...
        <Text
          ...
          textAlign={{ base: "center" }}
          color={"#58595B"}
          fontSize={{ base: "18px", medium: "26px", xl: "32px" }}
          fontWeight={{ base: "400" }}
          lineHeight={{ base: "100%", xl: "130%" }}
          maxWidth={{
            base: "100%",
            medium: "calc(100% - 90px)",
            large: "calc(100% - 90px)",
            xl: "calc(100% - 304px)",
            xxl: "calc(100% - 500px)",
          }}
        ...
        >
          Automotores Toyota Colombia S.A.S. informa, en línea con los
          principios de calidad, seguridad y atención al cliente de TOYOTA,
          sobre el inicio de campañas especiales de servicio para algunos
      ...
      >
        ...
        >
          ...
          través de la línea gratuita nacional 01 8000 123 691 o la línea
          3103157486 en Bogotá.
        </Text>
      </Flex>
      ...
      >
        ...
        >
          <Grid
            ...
            templateColumns={{
              base: "repeat(2, 1fr)",
              xl: `repeat(${calculateColumns()}, 1fr)`,
            }}
          ...
          {campaigns.length > (window.innerWidth >= 1280 ? 10 : 4) && (
            <Button
              borderRadius={{ base: "6.25rem" }}
            ...
            >
              {expanded ? "Ver menos" : "Ver más campañas"}
            </Button>
          )}
        </Flex>
      </Flex>
      ...
      <Flex
        ...
        padding={{
          base: "1rem 1rem 3.31rem 1rem",
          xl: "1rem 2rem 7.12rem",
        }}
      >
        <Flex
          direction={{ base: "column" }}
        ...
        >
          ...
          <Text
            ...
            lineHeight={{ base: "normal", xl: "130%" }}
            padding={{ base: "0", xl: "0" }}
            // margin={{base:"" ,large:"0 40px",xl:"0 74px" ,xxl:"0 226px"}}
            maxWidth={{
              base: "100%",
              medium: "100%",
              large: "calc(100% - 90px)",
          ...
          >
            ...
            VIN/Chasis en el espacio dispuesto a continuación.
            {/* <br /> */}
            Ten presente que este código se compone de 17 caracteres
            alfanuméricos que se encuentran en los documentos que acreditan la
            propiedad del vehículo (tarjeta de propiedad):
            {/* <br /> */}
