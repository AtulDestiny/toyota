...
const pageData: ComponentData[] = [
  ...
  },
  {
    ...
    props: {
      ...
      categories: [
        ...
        {
          title: "Categoría 3",
          description: "(11 a 13 años)",
        },
      ],
    },
  },
  {
    component: "WinnersCarousel",
    props: {
      // header: "Ganadores del concurso",
      // subHeader: "Concurso de dibujo",
      // subDescription: "Estos son los ganadores destacados del concurso 2024",
      data: [
        {
  ...
  },
  {
    component: "WinnersTabs",
    props: {
      bgimageSrc: "/images/Blue_Background_without_wave.png",
      title: "Ganadores 2023",
      imageSrc: "/images/sample-trophy.png",
      categories: [
        {
          title: "Categoría 1",
          description: "Categoría 1 (4 a 7 años)",
        },
        {
          title: "Categoría 2",
          description: "Categoría 2 (8 a 11 años)",
          // count: 196,
        },
        {
          title: "Categoría 3",
          description: "Categoría 3 (12 a 15 años)",
        },
      ],
    },
  },
