  ...
  return (
    <div>
      ...
      >
        ...
        >
          Programa de mantenimiento exclusivo ofrecido por Toyota en algunos de sus concesionarios donde se desarrolla el mantenimiento en un tiempo estimado de 1 hora, con la operación de 2 o 3 técnicos en perfecta sincronía atendiendo su vehículo.
        </Text>
      </Flex>
          ...
          >
            ...
            >
              <Text
                as="li"
                color={{ base: "#FFF" }}
                textAlign={{ base: "left", large: "left" }}
              ...
              >
                ...
                Operación sincronizada con dos o tres técnicos altamente capacitados, de acuerdo con la disponibilidad del concesionario.
              </Text>
            ...
            >
              ...
              >
                ...
                ></span>
                Balanceo y alineación incluidos en el mantenimiento en las rutinas y kilómetros aplicables.
              </Text>
            </Flex>
          </Grid>
        </Flex>
