    ...
    <div>
      ...
      {isMobile && (
        <Flex
          ...
          top={"-5px"}
          onClick={() =>
            (window.location.href = "/mi-toyota/mantenimiento/planeado/cotizar")
          }
        >
        ...
        >
          ...
          >
            ...
            >
              ...
              120.000 km., lo primero que ocurra. <br></br>
              Para los vehículos HEV, la garantía es de 8 años o 160.000 km
              sobre componentes específicos del sistema híbrido.
            </Text>
          </Flex>
        </Grid>
        ...
        >
          ...
          >
            ...
            ** 3 años o 100.000 km. correspondientes a la garantía de fábrica y
            ...
            <br />
            ***Para vehículos híbridos, la garantía cubre el vehículo en su
            totalidad durante los primeros 5 años. A partir del quinto año y
            hasta el octavo, la garantía aplica únicamente para los componentes
            del sistema híbrido, hasta un máximo de 160.000 km, lo que ocurra
            primero.
          </View>
        </Flex>
      </Flex>
