...
export default function AccesoriosPage({ slug }: { slug: string }) {
  ...
  const categorizedData = useMemo(() => {
    ...
    for (const item of data as VehicleCardProps[]) {
      const imageAttr = item.models?.items
      ...
      let imgUrl = imageAttr?.url || "/images/Image-not-found.png";
      if (
      ...
      if (
        ...
        ["land cruiser prado","yaris cross" ,"rav4","4runner", "fortuner","corolla cross" ,].includes(
