...
import Banner, { BannerFeature } from "@/components/Banner/Banner";
import {
  SliderSection,
  SliderSectionProps,
  SliderSectionTheme,
  ...
  return (
    <View position={isMobile ? "relative" : "static"}>
      ...
      <View position="relative">
        <Banner
          image={{
            mobile: "/images/24-interna-del-vehiculo-yaris.png",
            desktop: "/images/yaris-pro/hero-banner/yaris.png",
            alt: "Toyota Yaris 2025 en color rojo, diseño deportivo sobre carretera urbana",
          }}
      ...
      >
        <SliderSection headingAs={1} subtitleAs={2} {...sliderData} />;
      </Container>
      <Container
