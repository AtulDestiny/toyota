      ...
      <View paddingBottom={{ base: "4.25rem", xl: "120px" }}>
        ...
        <View padding={{ base: "0 0.94rem" }}>
          ...
          >
            ...
            >
              <Flex direction={{ base: "column" }} gap={{ base: "0.44rem" }}>
                ...
                >
                  ...
                  >
                    Corolla Cross 1.8 Seg Hybrid Tp 4x2
                  </Heading>
                  <Image
                    src={
                      isFavorite
              ...
              >
                {vehiclesData.map((vehicle) => (
                  <SwiperSlide key={vehicle.title}>
                    <Flex
                      justifyContent={{ base: "center" }}
                      padding={{ base: "0 3.12rem", xl: "0 8.94rem" }}
                      // backgroundColor={"#FFF"}
                    >
                      <Image
                        src={vehicle.src}
            ...
            {isMobile && vehiclesData.length > 0 ? (
              <Flex
                justifyContent={"space-between"}
                alignItems={"center"}
                width={"100%"}
        ...
        >
            ...
            <Flex as="ul" direction={{ base: "column" }} gap={{ base: "0" }}>
              ...
              <View as="li" marginLeft={{ base: "3ch" }}>
                <Text
                  ...
                  style={{ verticalAlign: "middle" }}
                >
                  Cuenta con garantía de concesionario Toyota{" "}
                </Text>
              </View>
          ...
          >
            ...
            <Text
              ...
              style={{ verticalAlign: "middle" }}
            >
              Ofertas válidas en el concesionario indicado en cada publicación,
              desde su fecha de 05/6/2024 al 05/6/2025 o hasta que la unidad
              publicada sea vendida, lo primero que ocurra. Los precios incluyen
              IVA. No incluyen gastos de transferencia ni flete ni seguro, ni la
              incidencia de los impuestos sobre dichos conceptos. La descripción
              de los vehículos, sus especificaciones técnicas y el equipamiento
              indicado en cada publicación son ingresados en el sitio por el
              concesionario vendedor. Toyota Argentina S.A. no asume
              responsabilidad alguna respecto de la veracidad y/o exactitud de
              los datos indicados ni interviene en la determinación de los
              precios ni en la operación de compraventa, que será concretada
              entre el cliente comprador y el concesionario vendedor.
            </Text>
          </Flex>
        </Grid>
            ...
            >
              <Swiper
                ...
                breakpoints={{
                  ...
                  768: {
                    slidesPerView: 2,
                    centeredSlides: false, // Disable for cleaner layout
                    spaceBetween: 10,
                  },
                  1024: {
                    slidesPerView: 3,
                ...
                modules={[Navigation]}
              >
                {vehiclesData_slider.map((vehicle) => (
              ...
              {isMobile && vehiclesData.length > 0 ? (
                ...
                >
                  ...
                  <Text
                    ...
                    fontFamily="var(--font-ToyotaType-Regular)"
                  >
                    {currentDetalleSimilar} de {totalPages}
                  </Text>
                  ...
                  >
                    ...
                    >
                      <rect
                        ...
                        height="30"
                        rx="15"
                        fill="url(#paint0_linear_4257_9476)"
                      />
                      <path
                        d="M24 10.41L28.58 15L24 19.59L25.41 21L31.41 15L25.41 9L24 10.41Z"
                        fill="#FFF"
                      />
                      <defs>
                        <linearGradient
                          id="paint0_linear_4257_9476"
                          x1="27.5"
                          y1="0"
                          x2="27.5"
                          y2="30"
