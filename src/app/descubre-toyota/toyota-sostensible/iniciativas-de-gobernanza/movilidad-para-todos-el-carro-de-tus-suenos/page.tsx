...
const pageData: ComponentData[] = [
  ...
  //     slides: [
  //       {
  //         imageMobile: "/images/image_social_desktop.png",
  //         imageDesktop:
  //           "/images/image_social_desktop.png",
  //         title: "Movilidad para todos",
  //         description: "",
  //       },
  //       // ... more slides
  ...
  //   },
  // },
  //add here tabs component : El carro de tus sueños
  {
...

  {
    ...
    props: {
      title: {
        ...
        lineHeight: "100%",
        textAlign: "left",
        padding: { base: "63px 15px 0px", xl: "0" },
        letterSpacing: "0",
      },
    },
  },
  ...
  //add here slider
  {
    ...
    props: {
      title: {
        text: "“Yo encontré a Nana un 31 de Octubre y desde ese día hemos sido inseparables, lleva 8 años conmigo. Me siento alegre, feliz de verlo con su regalo, mi nieta está orgullosa de ver que volvió a jugar como antes.” </br> </br>Carolina Rodriguez",
        fontSize: { base: "16px", xl: "22px" },
        fontFamily: "var(--font-toyotaDisplay)",
        fontStyle: "normal",
        fontWeight: "500",
