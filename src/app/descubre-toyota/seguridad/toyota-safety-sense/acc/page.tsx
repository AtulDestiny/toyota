...
const pageData: ComponentData[] = [
  {
    ...
    props: {
      slides: [
        {
          videoUrl: "/videos/safety-sense-interna3.mp4",
  ...
  // },
  {
    ...
    props: {
      layout: "horizontal",
      title: {
        text: `Control de velocidad crucero adaptativo (ACC)*`,
        fontSize: {
          base: "14px",
          medium: "14px",
          xl: "14px",
  ...
  },
  {
    ...
    props: {
      layout: "horizontal",
      title: {
        text: `Mantén una distancia segura con respecto al vehículo de adelante`,
        fontSize: {
          base: "56px",
          medium: "26px",
          xl: "56px",
      ...
      description: {
        text: `Dependiendo del modelo y/o versión de tu vehículo, superados los 30Km/h, se puede activar el Control de velocidad crucero adaptativo (ACC)*. El mismo, mantiene automáticamente una distancia y velocidad seguras entre los vehículos para alivianar la carga del conductor al conducir durante largos períodos en ruta.`,
  ...
  // Update Slider to accept dynamic props : Cuando el sistema detecta un
  {
    ...
    props: {
      title: "Información adicional sobre ACC",
      items: [
        {
          image: {},
          title: "",
          description: {
            intro:
              "En caso de que no haya algún vehículo al frente, el sistema mantendrá la velocidad establecida.",
            list: [],
          },
        },
        {
          ...
          description: {
            intro:
              "Cuando el sistema detecte un vehículo que circule a una velocidad menor a la seleccionada, este desacelerará para igualar la velocidad del vehículo detectado y mantener una distancia segura.",
            list: [],
          },
        },
        {
          ...
          description: {
            intro:
              "En el momento que el vehículo detectado cambie de carril, el sistema acelerará a la velocidad pre-establecida anteriormente.",
            list: [],
          },
        },
        // ... more items
      ...
      items: [
        {
          ...
          content: (
            <>
              <BulletListInfo
                items={[
                  "El sistema de Control de Velocidad Crucero Adaptativo (ACC)* podría no funcionar de manera óptima si:",
                  "- Cuando conduces en medio del tráfico o aceleras y frenas con frecuencia.",
                  "- Al cambiar de carril o al incorporarte a una autopista.",
                  "- Si el vehículo que va adelante es una moto o tiene mucha distancia al suelo.",
                  "- Cuando otro vehículo invade tu carril a muy poca distancia.",
                  "- Si el vehículo que va adelante sale del área de detección del sensor, como en una curva.",
                  "- Cuando el vehículo que va adelante circula cerca del borde de su carril o está fuera del área de detección.",
                  "- Si el vehículo que va adelante está arrastrando un remolque tipo plataforma, reduciendo el área de superficie trasera o tiene una forma irregular.",
                  "- Cuando transitas por vías con estructuras que sobresalen o bloquean la visibilidad, como túneles o puentes.",
                  "- Si el vehículo que va adelante está detenido o circula a una velocidad mucho menor a la establecida.",
                  "- Si el vehículo que va adelante invade tu carril, o si el carril es demasiado angosto y tiene curvas pronunciadas.",
                ]}
              />
            </>
          ),
