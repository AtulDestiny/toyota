...
export default function App() {
  ...
  const [price, setPrice] = useState<string>(""); // dynamic price state
  ...
  const dummyColorsList: ColorOption[] = [
    ...
    // },
    {
      ...
      imagePath: [
        "/images/fortuner/versiones/fortuner-sr-28-dsl-4x4-gris-metalico.png",
      ],
      name: "Gris Metálico",
      priority: 2,
    },
    ...
    // },
    {
      ...
      imagePath: [
        "/images/fortuner/versiones/fortuner-sr-28-dsl-4x4-plata-metalico.png",
      ],
      name: "Plata metálico",
      priority: 4,
    },
  ...
  const galleryData: ImageGalleryPreviewProps = {
    ...
    galleryLink:
      "/vehiculos/camionetas/fortuner/version/sr-2-8-diesel-4-x-4-at/galeria",
    tabs: [
      {
        title: "Exterior",
        items: [
  ...
  const vehicleNavigationData = {
    vehicleName: "FORTUNER SR 2.8 DIÉSEL 4X4 AT",
    ...
    sections: [
      ...
      },
      {
        ...
        links: [
          {
            label: "Exterior",
            href: "/vehiculos/camionetas/fortuner/version/sr-2-8-diesel-4-x-4-at/galeria#exterior",
          },
          {
            label: "Interior",
            href: "/vehiculos/camionetas/fortuner/version/sr-2-8-diesel-4-x-4-at/galeria#interior",
          },
          {
            label: "Vistas 360",
            href: "/vehiculos/camionetas/fortuner/version/sr-2-8-diesel-4-x-4-at/galeria#360",
          },
        ],
      },
  ...
  //       // Filter only active items for the current model/version
  //       const relevantItems = data.filter(
  //         (item) =>
  //           item.ACTIVO === "true" &&
  //           item.MODELO?.toUpperCase() === "FORTUNER" &&
  //           item.VERSION?.toUpperCase() ===
  // vehicleNavigationData.modelName.toUpperCase()
  //       );

  //       // Use reduce to find the latest year with the lowest price
          ...
          slides={[
            {
              ...
              alt: "Fortuner SR 2.8 Diésel 4x4 AT",
            },
          ]}
          features={bannerFeatures}
          title="Fortuner SR 2.8 Diésel 4x4 AT"
          price="Desde  $290.900.000*"
        />
      </View>
