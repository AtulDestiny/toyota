...
export default function App() {
  ...
  const galleryData: ImageGalleryPreviewProps = {
    ...
    galleryLink:
      "/vehiculos/camionetas/fortuner/version/sr-2-8-diesel-4-x-2-at/galeria",
    tabs: [
      {
        title: "Exterior",
        items: [
  ...
  const vehicleNavigationData = {
    vehicleName: "FORTUNER SR 2.8 DIÉSEL 4X2 AT",
    ...
    sections: [
      ...
      },
      {
        ...
        links: [
          {
            label: "Exterior",
            href: "/vehiculos/camionetas/fortuner/version/sr-2-8-diesel-4-x-2-at/galeria#exterior",
          },
          {
            label: "Interior",
            href: "/vehiculos/camionetas/fortuner/version/sr-2-8-diesel-4-x-2-at/galeria#interior",
          },
          {
            label: "Vistas 360",
            href: "/vehiculos/camionetas/fortuner/version/sr-2-8-diesel-4-x-2-at/galeria#360",
          },
        ],
      },
  ...
  //           item.VERSION?.toUpperCase() === vehicleNavigationData.modelName.toUpperCase()
  //       );
  ...
  //       if (best) {
  //         setGalleryPrice(`$${best.price.toLocaleString("es-CO")} COP`);
  //       }
  //     } catch (err) {
          ...
          slides={[
            {
              ...
              alt: "Fortuner SR 2.8 Diesél 4x2 AT",
            },
          ]}
          features={bannerFeatures}
          title="Fortuner SR 2.8 Diesél 4x2 AT"
          price="Desde  $239.900.000*"
        />
      </View>
