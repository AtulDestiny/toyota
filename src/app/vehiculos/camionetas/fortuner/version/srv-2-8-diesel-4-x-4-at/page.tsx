...
const items: MaterialCard[] = [
  {
    ...
    downloadUrl: "/images/pdf/FT-FORTUNER-AT.pdf",
  },
  {
...
export default function App() {
  ...
  const galleryData: ImageGalleryPreviewProps = {
    ...
    galleryLink:
      "/vehiculos/camionetas/fortuner/version/srv-2-8-diesel-4-x-4-at/galeria",
    tabs: [
      {
        title: "Exterior",
        items: [
  ...
  const vehicleNavigationData = {
    vehicleName: "FORTUNER SRV 2.8 DIÉSEL 4X4 AT",
    modelName: "FORTUNER SR 4X4 DIESEL 2.8",
    sections: [
      {
      ...
      },
      {
        ...
        links: [
          {
            label: "Exterior",
            href: "/vehiculos/camionetas/fortuner/version/srv-2-8-diesel-4-x-4-at/galeria#exterior",
          },
          {
            label: "Interior",
            href: "/vehiculos/camionetas/fortuner/version/srv-2-8-diesel-4-x-4-at/galeria#interior",
          },
          {
            label: "Vistas 360",
            href: "/vehiculos/camionetas/fortuner/version/srv-2-8-diesel-4-x-4-at/galeria#360",
          },
        ],
      },
  ...
  // console.log("galleryPrice" ,galleryPrice);
          ...
          slides={[
            {
              ...
              alt: "Fortuner SRV 2.8 Diésel 4x4 AT",
            },
          ]}
          features={bannerFeatures}
          title="Fortuner SRV 2.8 Diésel 4x4 AT"
          price="Desde  $329.500.000*"
        />
      </View>
