...
export default function App() {
  ...
  const dummyColorsList: ColorOption[] = [
    ...
    },
    {
      ...
      imagePath: [
        "/images/fortuner/versiones/srv-2-8-diesel-4-x-2-at/blanco-perla.png",
      ],
    ...
    },
    {
      ...
      imagePath: [
        "/images/fortuner/versiones/srv-2-8-diesel-4-x-2-at/gris-met.png",
      ],
      name: "Gris metálico",
      priority: 3,
    },
    {
      ...
      imagePath: [
        "/images/fortuner/versiones/srv-2-8-diesel-4-x-2-at/plata.png",
      ],
      name: "Plata Metálico",
      priority: 4,
    },
  ...
  const galleryData: ImageGalleryPreviewProps = {
    ...
    galleryLink:
      "/vehiculos/camionetas/fortuner/version/srv-2-8-diesel-4-x-2-at/galeria",
    tabs: [
      {
        title: "Exterior",
        items: [
          ...
          slides={[
            {
              ...
              alt: "Fortuner SRV 2.8 Diésel 4x2 AT",
            },
          ]}
          features={bannerFeatures}
          title="Fortuner SRV 2.8 Diésel 4x2 AT"
          price="Desde  $287.900.000*"
        />
      </View>
