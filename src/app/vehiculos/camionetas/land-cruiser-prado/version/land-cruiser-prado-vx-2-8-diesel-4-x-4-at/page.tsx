...
const specsData = [
  ...
  },
  {
    name: "Confort",
    details:
      "RADIO:   JBL + 12.3” con Android Auto y Apple Carplay CÁMARA: 360° multiterreno Suspensión Variable Adaptativa",
  },
  {
    name: "Transmisión",
...
export default function App() {
  ...
  const dummyColorsList: ColorOption[] = [
    {
      ...
      imagePath: ["/images/land-cruiser-prado/vx-img-001.png"],
    ...
    },
    {
      ...
      imagePath: [
        "/images/land-cruiser-prado/colores/negro-mica/TX-L-Negro-Mica-Fondo-Blanco-Frontal.png",
      ],
      name: "Negro Mica",
      priority: 3,
    },
  ...
  const galleryData: ImageGalleryPreviewProps = {
    ...
    galleryLink:
      "/vehiculos/camionetas/land-cruiser-prado/version/land-cruiser-prado-vx-2-8-diesel-4-x-4-at/galeria",
    tabs: [
      {
        title: "Exterior",
        items: [
  ...
  const vehicleNavigationData = {
    vehicleName: "Land Cruiser Prado VX 2.8 DIÉSEL 4X4 AT",
    ...
    sections: [
      ...
      },
      {
        ...
        links: [
          {
            label: "Exterior",
            href: "/vehiculos/camionetas/land-cruiser-prado/version/land-cruiser-prado-vx-2-8-diesel-4-x-4-at/galeria#exterior",
          },
          {
            label: "Interior",
            href: "/vehiculos/camionetas/land-cruiser-prado/version/land-cruiser-prado-vx-2-8-diesel-4-x-4-at/galeria#interior",
          },
        ],
      },
          ...
          slides={[
            {
              ...
              alt: "LAND CRUISER PRADO VX 2.8 DIÉSEL 4X4 AT",
            },
          ]}
          features={bannerFeatures}
          title="LAND CRUISER PRADO VX 2.8 DIÉSEL 4X4 AT"
          price="Desde  $526.500.000*"
        />
      </View>
