...
const specsData = [
  ...
  },
  {
    name: "Confort",
    details:
      "RADIO: 8 Con Android Auto y Apple Carplay FRENO DE ESTACIONAMIENTO: Eléctrico + Auto Hold Encendido por botón",
  },
  {
    name: "Transmisión",
...
export default function App() {
  ...
  const galleryData: ImageGalleryPreviewProps = {
    ...
    galleryLink:
      "/vehiculos/camionetas/land-cruiser/version/land-cruiser-79-4-0-gasolina-4-x-4-mt/galeria",
    tabs: [
      {
        title: "Exterior",
        items: [
  ...
  const vehicleNavigationData = {
    vehicleName: "Land Cruiser Prado TX 2.4 GASOLINA 4X4 AT",
    ...
    sections: [
      ...
      },
      {
        ...
        links: [
          {
            label: "Exterior",
            href: "/vehiculos/camionetas/land-cruiser-prado/version/land-cruiser-prado-tx-2-4-gasolina-4-x-4-at/galeria#exterior",
          },
          {
            label: "Interior",
            href: "/vehiculos/camionetas/land-cruiser-prado/version/land-cruiser-prado-tx-2-4-gasolina-4-x-4-at/galeria#interior",
          },
        ],
      },
  ...
  return (
    <View position={isMobile ? "relative" : "static"}>
          ...
          slides={[
            {
              ...
              alt: "LAND CRUISER PRADO TX 2.4 GASOLINA 4X4 AT",
            },
          ]}
      ...
      >
        <SectionTitle
          title={"Land Cruiser Prado TX Gasolina"}
          titleFontSize={{ base: "sm", xl: "md" }}
