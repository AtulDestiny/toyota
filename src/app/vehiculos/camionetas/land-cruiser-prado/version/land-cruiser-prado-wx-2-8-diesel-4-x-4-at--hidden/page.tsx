...
const specsData = [
  ...
  },
  {
    name: "Confort",
    details:
      "RADIO:  JBL + 12.3” con Android Auto y Apple Carplay CÁMARA: 360° multiterreno Desconexión de la barra estabilizadora frontal",
  },
  {
    name: "Transmisión",
...
export default function App() {
  ...
  const dummyColorsList: ColorOption[] = [
    {
      id: "1",
      iconPath: "/images/vehicle-colors/hd/arena.png",
      imagePath: [
        "/images/land-cruiser-prado-wx-2-8-diesel-4-x-4-at/arena-gris.png",
      ],
      name: "Arena Gris",
      priority: 1,
    },
    {
      ...
      imagePath: [
        "/images/land-cruiser-prado-wx-2-8-diesel-4-x-4-at/azul-niebla-gris.png",
      ],
      name: "Azul Niebla Gris",
      priority: 2,
    },
    {
      id: "3",
      ...
      imagePath: [
        "/images/land-cruiser-prado-wx-2-8-diesel-4-x-4-at/blanco-perla-metalizado.png",
      ],
    ...
    },
    {
      ...
      imagePath: [
        "/images/land-cruiser-prado-wx-2-8-diesel-4-x-4-at/bronce-metalico.png",
      ],
    ...
    },
    {
      ...
      imagePath: [
        "/images/land-cruiser-prado-wx-2-8-diesel-4-x-4-at/gris-oscuro.png",
      ],
      name: "Gris Oscuro",
      priority: 5,
    },
  ...
  const galleryData: ImageGalleryPreviewProps = {
    ...
    galleryLink:
      "/vehiculos/camionetas/land-cruiser-prado/version/land-cruiser-prado-wx-2-8-diesel-4-x-4-at/galeria",
    tabs: [
      {
        title: "Exterior",
        items: [
  ...
  const vehicleNavigationData = {
    vehicleName: "Land Cruiser Prado WX 2.8 DIÉSEL 4X4 AT",
    modelName: "Land Cruiser Prado DIÉSEL WX",
    sections: [
      {
      ...
      },
      {
        ...
        links: [
          {
            label: "Exterior",
            href: "/vehiculos/camionetas/land-cruiser-prado/version/land-cruiser-prado-wx-2-8-diesel-4-x-4-at/galeria#exterior",
          },
          {
            label: "Interior",
            href: "/vehiculos/camionetas/land-cruiser-prado/version/land-cruiser-prado-wx-2-8-diesel-4-x-4-at/galeria#interior",
          },
        ],
      },
  ...
  return (
    <View position={isMobile ? "relative" : "static"}>
          ...
          slides={[
            {
              ...
              alt: "LAND CRUISER PRADO WX 2.8 DIÉSEL 4X4 AT",
            },
          ]}
          features={bannerFeatures}
          title="LAND CRUISER PRADO WX 2.8 DIÉSEL 4X4 AT"
          price="Desde  $499.900.000*"
        />
      </View>
      ...
      >
        <SectionTitle
          title={"Land Cruiser Prado WX Diésel"}
          titleFontSize={{ base: "sm", xl: "md" }}
