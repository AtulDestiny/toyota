...
const specsData = [
  {
    name: "Motorización",
    details: "MOTOR: 2.4L Turbo Gasolina POTENCIA: 278 HP TORQUE: 430 NM",
  },
  {
    name: "Confort",
    details:
      "TAPICERÍA: Cuero RADIO: 12.3 Con Android Auto y Apple Carplay Sunroof",
  },
  {
    name: "Transmisión",
...
export default function App() {
  ...
  const dummyColorsList: ColorOption[] = [
    {
      ...
      imagePath: [
        "/images/land-cruiser-prado/colores/blanco-perla-metalizado/tx-l-2-4-gasolina-4-x-4-at.png",
      ],
    ...
    },
    {
      ...
      imagePath: [
        "/images/land-cruiser-prado/colores/bronce-metálico/tx-l-2-4-gasolina-4-x-4-at.png",
      ],
    ...
    },
    {
      ...
      imagePath: [
        "/images/land-cruiser-prado/colores/gris-oscuro/tx-l-2-4-gasolina-4-x-4-at.png",
      ],
      name: "Gris Oscuro",
      priority: 3,
    },
    {
      id: "4",
      iconPath: "/images/vehicle-colors/hd/negro.png",
      imagePath: [
        "/images/land-cruiser-prado/colores/negro/tx-l-2-4-gasolina-4-x-4-at.png",
      ],
      name: "Negro",
      priority: 5,
    },
    {
      ...
      imagePath: [
        "/images/land-cruiser-prado/colores/negro-mica/tx-l-2-4-gasolina-4-x-4-at.png",
      ],
      name: "Negro Mica",
      priority: 5,
    },
    {
      ...
      imagePath: [
        "/images/land-cruiser-prado/colores/super-blanco/tx-l-2-4-gasolina-4-x-4-at.png",
      ],
      name: "Súper Blanco",
      priority: 6,
    },
  ...
  const galleryData: ImageGalleryPreviewProps = {
    ...
    galleryLink:
      "/vehiculos/camionetas/land-cruiser/version/land-cruiser-prado-tx-l-2-4-gasolina-4-x-4-at/galeria",
    tabs: [
      {
        title: "Exterior",
        items: [
  ...
  const vehicleNavigationData = {
    vehicleName: "Land Cruiser Prado TX-L 2.4 GASOLINA 4X4 AT",
    ...
    sections: [
      ...
      },
      {
        ...
        links: [
          {
            label: "Exterior",
            href: "/vehiculos/camionetas/land-cruiser-prado/version/land-cruiser-prado-tx-l-2-4-gasolina-4-x-4-at/galeria#exterior",
          },
          {
            label: "Interior",
            href: "/vehiculos/camionetas/land-cruiser-prado/version/land-cruiser-prado-tx-l-2-4-gasolina-4-x-4-at/galeria#interior",
          },
        ],
      },
  ...
  return (
    <View position={isMobile ? "relative" : "static"}>
          ...
          slides={[
            {
              ...
              alt: "LAND CRUISER PRADO TX-L 2.4 GASOLINA 4X4 AT",
            },
          ]}
          features={bannerFeatures}
          title="LAND CRUISER PRADO TX-L 2.4 GASOLINA 4X4 AT"
          price="Desde  $401.500.000*"
        />
      </View>
      ...
      >
        <SectionTitle
          title={"Land Cruiser Prado TX-L Gasolina"}
          titleFontSize={{ base: "sm", xl: "md" }}
