...
export default function VehicleClient({ slug }: { slug: string }) {
  const {
    data: vehicle,
    isLoading,
    isError,
      ...
      <View position="relative">
        <BannerWithVideo
          slides={[{
            ...
            alt: vehicle?.name || "Land Cruiser Prado",
          }]}
          title={vehicle?.name || "Land Cruiser Prado"}
          price={vehicle?.price || "Desde $303.500.000*"}
        />
        <Flex
          className="shortcuts"
          position="absolute"
