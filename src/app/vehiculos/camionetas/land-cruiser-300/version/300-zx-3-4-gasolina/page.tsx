...
export default function App() {
  ...
  const galleryData: ImageGalleryPreviewProps = {
    ...
    galleryLink:
      "/vehiculos/camionetas/land-cruiser-300/version/300-zx-3-4-gasolina/galeria",
    tabs: [
      {
        title: "Exterior",
        items: [
          ...
          slides={[
            {
              ...
              alt: "LAND CRUISER 300 ZX 3.4 GASOLINA 4X4 AT",
            },
          ]}
