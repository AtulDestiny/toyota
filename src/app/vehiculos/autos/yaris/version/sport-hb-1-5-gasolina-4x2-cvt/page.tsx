...
const specsData = [
  ...
  },
  {
    name: "Confort",
    details:
      "TAPICERÍA: Cuero RADIO: 6,8 con Android Auto y Apple Carplay Encendido por botón",
  },
  {
    name: "Transmisión",
    details: " CVT",
...
export default function App() {
  ...
  const galleryData: ImageGalleryPreviewProps = {
    ...
    galleryLink:
      "/vehiculos/autos/yaris/version/sport-hb-1-5-gasolina-4x2-cvt/galeria",
    tabs: [
      {
        title: "Exterior",
        items: [
          ...
          slides={[
            {
              ...
              alt: "YARIS SPORT HB 1.5 GASOLINA 4X2 CVT",
            },
          ]}
          features={bannerFeatures}
          title="YARIS SPORT HB 1.5 GASOLINA 4X2 CVT"
          price="Desde   $99.500.000*"
        />
      </View>
