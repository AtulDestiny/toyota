...
const vehicleNavigationData = {
  vehicleName: "YARIS SPORT HB 1.5 GASOLINA 4X2 CVT",
  sections: [
    {
    ...
    },
    {
      ...
      links: [
        {
          label: "Exterior",
          href: "/vehiculos/autos/yaris/version/sport-hb-1-5-gasolina-4x2-cvt/galeria#exterior",
        },
        {
          label: "Interior",
          href: "/vehiculos/autos/yaris/version/sport-hb-1-5-gasolina-4x2-cvt/galeria#interior",
        },
        {
          label: "Vistas 360",
          href: "/vehiculos/autos/yaris/version/sport-hb-1-5-gasolina-4x2-cvt/galeria#360",
        },
      ],
    },
...
export default function Galeria() {
  ...
  const exteriorImages = [
    {
      imagePath: "/images/yaris-pro/exterior/HGF_0233.jpg",
      coverText: "Título de la imagen",
      priority: 2,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/yaris-pro/exterior/HGF_0236.jpg",
      coverText: "Título de la imagen",
      priority: 3,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/yaris-pro/exterior/HGF_0251.jpg",
      coverText: "Título de la imagen",
      priority: 4,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/yaris-pro/exterior/HGF_0277.jpg",
      coverText: "Título de la imagen",
      priority: 5,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/yaris-pro/exterior/HGF_0280.jpg",
      coverText: "Título de la imagen",
      priority: 6,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/yaris-pro/exterior/HGF_0314.jpg",
      coverText: "Título de la imagen",
      priority: 7,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/yaris-pro/exterior/HGF_0337.jpg",
      coverText: "Título de la imagen",
      priority: 8,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/yaris-pro/exterior/HGF_0460.jpg",
      coverText: "Título de la imagen",
      priority: 9,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/yaris-pro/exterior/HGF_0472.jpg",
      coverText: "Título de la imagen",
      priority: 10,
      description: "*Imagen de referencia",
    },
  ...
  const interiorImages = [
    {
      imagePath: "/images/yaris-pro/interior/HGF_0221.jpg",
      coverText: "Título de la imagen",
      priority: 1,
      title: "Slide title",
      description: "*Imagen de referencia",
    ...
    {
      imagePath: "/images/yaris-pro/interior/HGF_0224.jpg",
      coverText: "Título de la imagen",
      priority: 2,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/yaris-pro/interior/HGF_0241.jpg",
      coverText: "Título de la imagen",
      priority: 3,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/yaris-pro/interior/HGF_0262.jpg",
      coverText: "Título de la imagen",
      priority: 4,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/yaris-pro/interior/HGF_0269.jpg",
      coverText: "Título de la imagen",
      priority: 5,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/yaris-pro/interior/HGF_0274.jpg",
      coverText: "Título de la imagen",
      priority: 6,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/yaris-pro/interior/HGF_0444.jpg",
      coverText: "Título de la imagen",
      priority: 7,
      description: "*Imagen de referencia",
    },
  ...
  return (
    <View position={"relative"}>
      ...
      <View padding={{ base: "2rem 0rem", xl: "4rem" }}>
        <SectionTitle
          title={"Galería"}
          subtitle={"YARIS SPORT HB 1.5 GASOLINA 4X2 CVT"}
