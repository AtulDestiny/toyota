...
export default function App() {
  ...
  const vehicles = [
    {
      imageSrc: "/images/corolla-grs/versions/blanco.png",
      title: "COROLLA GR-S 2.0 GASOLINA 4X2 CVT",
      modelName: "COROLLA GR-S",
      price: "$130.900.000",
      description:
        "Rendimiento Superior: El Corolla Sedán GRS combina un motor potente con un diseño aerodinámico, ofreciendo una experiencia de conducción emocionante.",
      buttonText: "Explorar esta versión",
      link: "/vehiculos/deportivos-tgr/corolla-gr-s/version/gr-s-2-0-gasolina",
    },
  ];
  ...
  const galleryData: ImageGalleryPreviewProps = {
    ...
    galleryLink: "/vehiculos/deportivos-tgr/corolla-gr-s/galeria",
    tabs: [
      {
        title: "Exterior",
        items: [
  ...
  const sliderData: SliderSectionProps = {
    ...
    title: isMobile ? "Diferenciales" : "Razones para tener un COROLLA GR-S",
    description: isMobile
      ? "Razones para tener un COROLLA GR-S"
      : "Diferenciales",
    ...
    items: [
      ...
      {
        image: {
          src: "/images/corolla-grs/diffrentials/img3.jpg",
          alt: "Ejemplo 3",
        },
    ...
    <View position={isMobile ? "relative" : "static"}>
      ...
      <Container padding={{ base: "3rem 0", xl: "5.125rem 0" }}>
        ...
        {isMobile ? (
          ...
          >
            Corolla GR-S se destaca por ser un vehículo amplio, dándole al
            conductor y sus ocupantes una sensación de confort, donde sobresale
            la alta calidad en sus materiales.
          </Text>
        ) : (
          <Text
            fontSize={{ xl: "lg" }}
