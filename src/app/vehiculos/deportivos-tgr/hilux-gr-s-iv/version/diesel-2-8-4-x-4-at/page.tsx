...
export default function App() {
  ...
  const dummyColorsList: ColorOption[] = [
    ...
    //   imagePath: ["/images/hilux-gr-s-vi/versions/gris.png"],
    //   name: "Gris Metálico",
    //   priority: 2,
    // },
    {
  ...
  const vehicleNavigationData = {
    vehicleName: "HILUX D.C. GR-S IV DIÉSEL 2.8 4X4 AT",
    ...
    sections: [
      ...
      },
      {
        ...
        links: [
          {
            label: "Exterior",
            href: "/vehiculos/deportivos-tgr/hilux-gr-s-iv/version/diesel-2-8-4-x-4-at/galeria#exterior",
          },
          {
            label: "Interior",
            href: "/vehiculos/deportivos-tgr/hilux-gr-s-iv/version/diesel-2-8-4-x-4-at/galeria#interior",
          },
          {
            label: "Vistas 360",
            href: "/vehiculos/deportivos-tgr/hilux-gr-s-iv/version/diesel-2-8-4-x-4-at/galeria#interior",
  ...
  return (
    <View position={isMobile ? "relative" : "static"}>
          ...
          slides={[
            {
              ...
              alt: "HILUX D.C. GR-S IV DIÉSEL 2.8 4X4 AT",
            },
          ]}
      ...
      <Container padding={{ base: "3rem 0", xl: "5.125rem 0" }}>
        ...
        <SectionTitle
          title={"Hilux GR-S IV Diesel 2.8 4x4 AT"}
