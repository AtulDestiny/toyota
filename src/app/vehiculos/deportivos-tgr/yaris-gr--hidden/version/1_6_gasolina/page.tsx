...
const specsData = [
  {
    name: "Motorización",
    details: " MOTOR: 1.6L Turbo Gasolina; POTENCIA: 268 HP; TORQUE: 370 NM",
  },
  {
    name: "Confort",
    details:
      "TAPICERÍA: Tipo gamuza deportiva; TRANSMISIÓN: Manual inteligente (IMT); Amplificación del sonido del motor",
  },
  {
    name: "Transmisión",
...
export default function App() {
  ...
  const vehicleNavigationData = {
    vehicleName: "GR YARIS 1.6 GASOLINA 4X4 MT",
    modelName: "GR YARIS",
    sections: [
      {
      ...
      },
      {
        ...
        links: [
          ...
          },
          {
            ...
            redirect: "/images/pdf/Manual_del_buen_conductor_Toyota.pdf",
          },
          {
          ...
          slides={[
            {
              ...
              alt: "GR YARIS 1.6 GASOLINA 4X4 MT",
            },
          ]}
