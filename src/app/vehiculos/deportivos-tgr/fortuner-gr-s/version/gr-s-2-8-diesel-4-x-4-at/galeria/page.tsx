...
export default function Galeria() {
  ...
  const exteriorImages = [
    {
      imagePath: "/images/fortuner-gr-s/exteriores/4052.jpg",
    ...
    {
      imagePath: "/images/fortuner-gr-s/exteriores/4226.jpg",
      coverText: "Título de la imagen",
      priority: 2,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/fortuner-gr-s/exteriores/4254.jpg",
      coverText: "Título de la imagen",
      priority: 3,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/fortuner-gr-s/exteriores/4265.jpg",
      coverText: "Título de la imagen",
      priority: 4,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/fortuner-gr-s/exteriores/4290.jpg",
      coverText: "Título de la imagen",
      priority: 5,
      description: "*Imagen de referencia",
    },
  ...
  const interiorImages = [
    {
      imagePath: "/images/fortuner-gr-s/interiores/3852.jpg",
      coverText: "Título de la imagen",
      priority: 1,
      title: "Slide title",
      description: "*Imagen de referencia",
    ...
    {
      imagePath: "/images/fortuner-gr-s/interiores/3940.jpg",
      coverText: "Título de la imagen",
      priority: 2,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/fortuner-gr-s/interiores/3966.jpg",
      coverText: "Título de la imagen",
      priority: 3,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/fortuner-gr-s/interiores/3992.jpg",
      coverText: "Título de la imagen",
      priority: 4,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/fortuner-gr-s/interiores/4491.jpg",
      coverText: "Título de la imagen",
      priority: 5,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/fortuner-gr-s/interiores/4497.jpg",
      coverText: "Título de la imagen",
      priority: 6,
      description: "*Imagen de referencia",
    },
  ...
  return (
    <View position={"relative"}>
      ...
      <VehicleShortcuts technicalSpecs="/images/pdf/FT-FORTUNER-GRS-2024.pdf" />
      <View padding={{ base: "2rem 0rem", xl: "4rem" }}>
        <SectionTitle
          title={"Galería"}
          subtitle={"Fortuner SR 2.8 Diésel 4x4 AT"}
