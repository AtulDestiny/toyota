...
const dummyColorsList: ColorOption[] = [
  {
    ...
    imagePath: ["/images/corolla-cross-gr/attract/11.jpg"],
    name: "Blanca",
    priority: 1,
  },
];
...
export default function Galeria() {
  ...
  const exteriorImages = [
    ...
    {
      imagePath: "/images/corolla-cross-gr/exterior/18.jpg",
      coverText: "Título de la imagen",
      priority: 14,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/corolla-cross-gr/exterior/19.jpg",
      coverText: "Título de la imagen",
      priority: 14,
      description: "*Imagen de referencia",
    },
