...
export default function App() {
  ...
  const galleryData: ImageGalleryPreviewProps = {
    ...
    galleryLink:
      "/vehiculos/deportivos-tgr/corolla-cross-gr/version/gr-s-2-0-gasolina/galeria",
    tabs: [
      {
        title: "Exterior",
        items: [
          ...
          {
            src: "/images/corolla-cross-gr/exterior/ex18.jpg",
            alt: "Título de la imagen",
          },
          {
            src: "/images/corolla-cross-gr/exterior/ex19.jpg",
            alt: "Título de la imagen",
          },
        ],
      },
          ...
          slides={[
            {
              ...
              alt: "COROLLA CROSS GR-S 2.0 GASOLINA 4X2 CVT",
            },
          ]}
