...
export default function App() {
  ...
  const dummyColorsList: ColorOption[] = [
    {
      id: "1",
      iconPath: "/images/vehicle-colors/platinum-white-pearl.png",
    ...
    tabs: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            src: "/images/land-cruiser-300/interior/grs/in5.jpg",
            alt: "Título de la imagen",
          },
          {
          ...
          slides={[
            {
              ...
              alt: "LAND CRUISER 300 GR-S 3.4 GASOLINA 4X4 AT",
            },
          ]}
