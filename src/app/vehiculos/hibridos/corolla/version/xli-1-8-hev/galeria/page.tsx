...
export default function Galeria() {
  ...
  const exteriorImages = [
    {
      imagePath: "/images/corolla/exterior/XLI/cr1.jpg",
    ...
    {
      imagePath: "/images/corolla/exterior/XLI/cr2.jpg",
      coverText: "Título de la imagen",
      priority: 2,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/corolla/exterior/XLI/cr3.jpg",
      coverText: "Título de la imagen",
      priority: 3,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/corolla/exterior/XLI/cr4.jpg",
      coverText: "Título de la imagen",
      priority: 4,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/corolla/exterior/XLI/cr5.jpg",
      coverText: "Título de la imagen",
      priority: 5,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/corolla/exterior/XLI/cr6.jpg",
      coverText: "Título de la imagen",
      priority: 6,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/corolla/exterior/XLI/cr7.jpg",
      coverText: "Título de la imagen",
      priority: 7,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/corolla/exterior/XLI/cr8.jpg",
      coverText: "Título de la imagen",
      priority: 8,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/corolla/exterior/XLI/cr9.jpg",
      coverText: "Título de la imagen",
      priority: 9,
      description: "*Imagen de referencia",
    },
  ...
  const interiorImages = [
    {
      imagePath: "/images/corolla/interior/XLI/cr1.jpg",
      coverText: "Título de la imagen",
      priority: 1,
      title: "Slide title",
      description: "*Imagen de referencia",
    ...
    {
      imagePath: "/images/corolla/interior/XLI/cr2.jpg",
      coverText: "Título de la imagen",
      priority: 2,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/corolla/interior/XLI/cr3.jpg",
      coverText: "Título de la imagen",
      priority: 3,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/corolla/interior/XLI/cr4.jpg",
      coverText: "Título de la imagen",
      priority: 4,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/corolla/interior/XLI/cr5.jpg",
      coverText: "Título de la imagen",
      priority: 5,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/corolla/interior/XLI/cr6.jpg",
      coverText: "Título de la imagen",
      priority: 6,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/corolla/interior/XLI/cr7.jpg",
      coverText: "Título de la imagen",
      priority: 7,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/corolla/interior/XLI/cr8.jpg",
      coverText: "Título de la imagen",
      priority: 8,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/corolla/interior/XLI/cr9.jpg",
      coverText: "Título de la imagen",
      priority: 9,
      description: "*Imagen de referencia",
    },
  ...
  const vehicleNavigationData = {
    vehicleName: "COROLLA XLI 1.8 HEV 4X2 E-CVT",
    sections: [
      {
        title: "Información Ficha Técnica",
        redirect: "/images/pdf/FT-COROLLA-XLI-1-8-HEV.pdf",
      },
      {
        title: "Versiones",
        links: [
        ...
        links: [
          {
            ...
            href: "/images/pdf/FT-COROLLA-XLI-1-8-HEV.pdf",
          },
        ],
      },
      {
        ...
        links: [
          {
            label: "Exterior",
            href: "/vehiculos/hibridos/corolla/version/xli-1-8-hev/galeria#exterior",
          },
          {
            label: "Interior",
            href: "/vehiculos/hibridos/corolla/version/xli-1-8-hev/galeria#interior",
          },
          {
            label: "Vistas 360",
            href: "/vehiculos/hibridos/corolla/version/xli-1-8-hev/galeria#360",
          },
        ],
      },
      {
  ...
  return (
    <View position={"relative"}>
      ...
      <VehicleShortcuts technicalSpecs="/images/pdf/FT-COROLLA-XLI-1-8-HEV.pdf" />
      <View padding={{ base: "2rem 0rem", xl: "4rem" }}>
        <SectionTitle
          title={"Galería"}
          subtitle={"COROLLA XLI HEV"}
