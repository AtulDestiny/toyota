...
export default function App() {
  ...
  const dummyColorsList: ColorOption[] = [
    {
      ...
      imagePath: ["/images/corolla/versions/xli/Blanco-perlado.png"],
    ...
    },
    {
      ...
      imagePath: ["/images/corolla/versions/xli/Celestite-Gray.png"],
      name: "Gris Celeste",
      priority: 2,
    },
    {
      ...
      imagePath: ["/images/corolla/versions/xli/Gray-ME.png"],
      name: "Gris Metálico",
      priority: 3,
    },
    {
      ...
      imagePath: ["/images/corolla/versions/xli/Negro-MC.png"],
      name: "Negro",
      priority: 4,
    },
    {
      ...
      imagePath: ["/images/corolla/versions/xli/Gray-MM.png"],
      name: "Plata metálico",
      priority: 5,
    },
    {
      ...
      imagePath: ["/images/corolla/versions/xli/Rojo-Mica.png"],
    ...
    },
    {
      ...
      imagePath: ["/images/corolla/versions/xli/Super-white.png"],
      name: "Súper Blanco",
      priority: 7,
    },
  ];
  ...
  const galleryData: ImageGalleryPreviewProps = {
    ...
    galleryLink: "/vehiculos/hibridos/corolla/version/xli-1-8-hev/galeria",
    tabs: [
      {
        title: "Exterior",
        items: [
          ...
          slides={[
            {
              ...
              alt: "COROLLA XLI 1.8 HEV 4X2 E-CVT",
            },
          ]}
