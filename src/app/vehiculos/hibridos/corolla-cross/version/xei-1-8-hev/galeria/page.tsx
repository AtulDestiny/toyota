...
export default function Galeria() {
  ...
  const vehicleNavigationData = {
    vehicleName: "COROLLA CROSS XEI 1.8 HEV 4X2 E-CVT",
    sections: [
      {
      ...
      },
      {
        ...
        links: [
          {
            label: "Exterior",
            href: "/vehiculos/hibridos/corolla-cross/version/xei-1-8-hev/galeria#exterior",
          },
          {
            label: "Interior",
            href: "/vehiculos/hibridos/corolla-cross/version/xei-1-8-hev/galeria#interior",
          },
          {
            label: "Vistas 360",
            href: "/vehiculos/hibridos/corolla-cross/version/xei-1-8-hev/galeria#360",
          },
        ],
      },
      {
  ...
  return (
    <View position={"relative"}>
      ...
      <View padding={{ base: "2rem 0rem", xl: "4rem" }}>
        <SectionTitle
          title={"Galería"}
          subtitle={"COROLLA CROSS XEI 1.8 HEV 4X2 E-CVT"}
