...
export default function App() {
  ...
  const dummyColorsList: ColorOption[] = [
    {
      ...
      imagePath: ["/images/corolla-cross/versions/xei/azul-osc.png"],
    ...
    },
    {
      ...
      imagePath: ["/images/corolla-cross/versions/xei/blanco-perla.png"],
    ...
    },
    {
      ...
      imagePath: ["/images/corolla-cross/versions/xei/gris-met.png"],
      name: "Gris Metálico",
      priority: 3,
    },
    {
      ...
      imagePath: ["/images/corolla-cross/versions/xei/negro-mica.png"],
      name: "Negro mica",
      priority: 4,
    },
    {
      ...
      imagePath: ["/images/corolla-cross/versions/xei/plata.png"],
      name: "Plata",
      priority: 5,
    },
    {
      ...
      imagePath: ["/images/corolla-cross/versions/xei/rojo-mica.png"],
    ...
    },
    {
      ...
      imagePath: ["/images/corolla-cross/versions/xei/super-blanco.png"],
      name: "Súper Blanco",
      priority: 7,
    },
  ];
  ...
  const galleryData: ImageGalleryPreviewProps = {
    ...
    galleryLink:
      "/vehiculos/hibridos/corolla-cross/version/xei-1-8-hev/galeria",
    tabs: [
      {
        title: "Exterior",
        items: [
          ...
          slides={[
            {
              ...
              alt: "COROLLA CROSS XEI 1.8 HEV 4X2 E-CVT",
            },
          ]}
