...
export default function Galeria() {
  ...
  const exteriorImages = [
    {
      imagePath: "/images/corolla-cross/exterior/ex1.jpg",
    ...
    {
      imagePath: "/images/corolla-cross/exterior/ex2.jpg",
      coverText: "Título de la imagen",
      priority: 2,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/corolla-cross/exterior/ex3.jpg",
      coverText: "Título de la imagen",
      priority: 3,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/corolla-cross/exterior/ex4.jpg",
      coverText: "Título de la imagen",
      priority: 4,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/corolla-cross/exterior/ex5.jpg",
      coverText: "Título de la imagen",
      priority: 5,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/corolla-cross/exterior/ex6.jpg",
      coverText: "Título de la imagen",
      priority: 6,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/corolla-cross/exterior/ex7.jpg",
      coverText: "Título de la imagen",
      priority: 7,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/corolla-cross/exterior/ex8.jpg",
      coverText: "Título de la imagen",
      priority: 8,
      description: "*Imagen de referencia",
    },
  ...
  const interiorImages = [
    {
      imagePath: "/images/corolla-cross/interior/in1.jpg",
      coverText: "Título de la imagen",
      priority: 1,
      title: "Slide title",
      description: "*Imagen de referencia",
    ...
    {
      imagePath: "/images/corolla-cross/interior/in2.jpg",
      coverText: "Título de la imagen",
      priority: 2,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/corolla-cross/interior/in3.jpg",
      coverText: "Título de la imagen",
      priority: 3,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/corolla-cross/interior/in4.jpg",
      coverText: "Título de la imagen",
      priority: 4,
      description: "*Imagen de referencia",
    },
    {
      imagePath: "/images/corolla-cross/interior/in5.jpg",
      coverText: "Título de la imagen",
      priority: 5,
      description: "*Imagen de referencia",
    },
  ...
  const vehicleNavigationData = {
    vehicleName: "COROLLA CROSS SEG 2.0 GASOLINA 4X2 CVT",
    sections: [
      {
      ...
      },
      {
        ...
        links: [
          {
            label: "Exterior",
            href: "/vehiculos/hibridos/corolla-cross/version/seg-2-0-gasolina/galeria#exterior",
          },
          {
            label: "Interior",
            href: "/vehiculos/hibridos/corolla-cross/version/seg-2-0-gasolina/galeria#interior",
          },
          {
            label: "Vistas 360",
            href: "/vehiculos/hibridos/corolla-cross/version/seg-2-0-gasolina/galeria#360",
          },
        ],
      },
      {
  ...
  return (
    <View position={"relative"}>
      ...
      <VehicleShortcuts technicalSpecs="/images/pdf/FT-COROLLA-CROSS-2026.pdf" />
      <View padding={{ base: "2rem 0rem", xl: "4rem" }}>
        <SectionTitle
          title={"Galería"}
          subtitle={"COROLLA CROSS SEG 2.0 GASOLINA 4X2 CVT"}
