...
export default function App() {
  ...
  const dummyColorsList: ColorOption[] = [
    ...
    },
    {
      ...
      imagePath: [
        "/images/corolla-cross/versions/seg/update/blanco-perlado-metalizado.png",
      ],
    ...
    },
    {
      ...
      imagePath: [
        "/images/corolla-cross/versions/seg/update/gris-metalico.png",
      ],
      name: "Gris Metálico",
      priority: 3,
    },
    {
      ...
      imagePath: ["/images/corolla-cross/versions/seg/update/negro-mica.png"],
      name: "Negro mica",
      priority: 4,
    },
    {
      ...
      imagePath: ["/images/corolla-cross/versions/seg/update/plata.png"],
      name: "Plata",
      priority: 5,
    },
    {
      ...
      imagePath: ["/images/corolla-cross/versions/seg/update/rojo-mica.png"],
    ...
    },
    {
      ...
      imagePath: ["/images/corolla-cross/versions/seg/update/super-blanco.png"],
      name: "Súper Blanco",
      priority: 7,
    },
  ];
  ...
  const galleryData: ImageGalleryPreviewProps = {
    ...
    galleryLink:
      "/vehiculos/hibridos/corolla-cross/version/seg-2-0-gasolina/galeria",
    tabs: [
      {
        title: "Exterior",
        items: [
      ...
      <View position="relative">
        <BannerWithVideo
          slides={[
            {
              imageMobile:
                "/images/corolla-cross/versions/seg/banner/banner.png",
              imageDesktop:
                "/images/corolla-cross/versions/seg/banner/banner--desktop.png",
              alt: "COROLLA CROSS SEG 2.0 GASOLINA 4X2 CVT",
            },
          ]}
          features={bannerFeatures}
          title="COROLLA CROSS SEG 2.0 GASOLINA 4X2 CVT"
          price="Desde $148.500.000*"
        />
      </View>
