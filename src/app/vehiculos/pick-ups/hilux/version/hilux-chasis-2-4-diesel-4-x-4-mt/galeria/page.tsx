...
export default function Galeria() {
  ...
  const vehicleNavigationData = {
    vehicleName: "Hilux Chasís",
    sections: [
      {
        title: "Información Ficha Técnica",
        redirect: "/images/pdf/FT_HILUX_GRS4-Ajuste-2025",
      },
      {
        title: "Versiones",
        links: [
        ...
        links: [
          {
            ...
            href: "/images/pdf/FT_HILUX_GRS4-Ajuste-2025",
          },
        ],
      },
      {
        ...
        links: [
          {
            label: "Exterior",
            href: "/vehiculos/pick-ups/hilux/version/hilux-chasis/galeria#exterior",
          },
          {
            label: "Interior",
            href: "/vehiculos/pick-ups/hilux/version/hilux-chasis/galeria#interior",
          },
          {
            label: "Vistas 360",
            href: "/vehiculos/pick-ups/hilux/version/hilux-chasis/galeria#360",
          },
        ],
      },
      {
  ...
  return (
    <View position={"relative"}>
      ...
      <VehicleShortcuts
        customSlug="hilux"
        technicalSpecs="/images/pdf/FT_HILUX_GRS4-Ajuste-2025"
      />
      <View padding={{ base: "2rem 0rem", xl: "4rem" }}>
        <SectionTitle
          title={"Galería"}
          subtitle={"HILUX CHASÍS 2.4 DIÉSEL 4X4 MT"}
