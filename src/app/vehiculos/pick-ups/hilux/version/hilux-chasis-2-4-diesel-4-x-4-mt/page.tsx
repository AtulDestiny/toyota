...
export default function App() {
  ...
  const dummyColorsList: ColorOption[] = [
    {
      ...
      imagePath: ["/images/hilux-chasis/Hilux-chasis-756x504-1.png"],
      name: "Súper blanco",
      priority: 1,
    },
  ];
  ...
  const galleryData: ImageGalleryPreviewProps = {
    ...
    galleryLink:
      "/vehiculos/pick-ups/hilux/version/hilux-chasis-2-4-diesel-4-x-4-mt/galeria",
    tabs: [
      {
        title: "Exterior",
        items: [
          {
            src: "/images/hilux-chasis-2-4-diesel-4-x-4-mt/3-4-FRONTAL-IZQ.jpg",
            alt: "Título de la imagen",
          },
          {
            src: "/images/hilux-chasis-2-4-diesel-4-x-4-mt/3-4-TRASERA-DER.jpg",
            alt: "Título de la imagen",
          },
          {
            src: "/images/hilux-chasis-2-4-diesel-4-x-4-mt/3-4-TRASERA-IZQ.jpg",
            alt: "Título de la imagen",
          },
          {
            src: "/images/hilux-chasis-2-4-diesel-4-x-4-mt/FRONTAL.jpg",
            alt: "Título de la imagen",
          },
          {
            src: "/images/hilux-chasis-2-4-diesel-4-x-4-mt/LATERAL-DER.jpg",
            alt: "Título de la imagen",
          },
          {
            src: "/images/hilux-chasis-2-4-diesel-4-x-4-mt/TRASERA.jpg",
            alt: "Título de la imagen",
          },
        ],
      },
  ...
  const vehicleNavigationData = {
    vehicleName: "HILUX CHASÍS 2.4 DIÉSEL 4X4 MT",
    ...
    sections: [
      ...
      },
      {
        ...
        links: [
          ...
          },
          {
            ...
            href: "/detalle/hilux-chasis/version/hilux-chasis-2-4-diesel-4-x-4-mt",
          },
          {
      ...
      },
      {
        ...
        links: [
          {
            label: "Exterior",
            href: "/vehiculos/pick-ups/hilux/version/hilux-chasis-2-4-diesel-4-x-4-mt/galeria#exterior",
          },
          {
            label: "Interior",
            href: "/vehiculos/pick-ups/hilux/version/hilux-chasis-2-4-diesel-4-x-4-mt/galeria#interior",
          },
        ],
      },
    ...
    <View position={isMobile ? "relative" : "static"}>
      ...
      <View position="relative">
        <BannerWithVideo
          slides={[
            {
              imageMobile: "/images/hilux-chasis/hero-banner/hero-banner.png",
              imageDesktop:
                "/images/hilux-chasis/hero-banner/hero-banner--desktop.png",
              alt: "HILUX CHASÍS 2.4 DIÉSEL 4X4 MT",
            },
          ]}
