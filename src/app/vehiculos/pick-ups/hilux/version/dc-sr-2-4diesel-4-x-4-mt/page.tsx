...
export default function App() {
  ...
  const dummyColorsList: ColorOption[] = [
    {
      ...
      imagePath: ["/images/hilux/versions/tc-sr/gris-met.png"],
      name: "Gris Metalico",
      priority: 1,
    },
    {
      ...
      imagePath: ["/images/hilux/versions/tc-sr/negro-mica.png"],
      name: "Negro Mica",
      priority: 2,
    },
    {
      ...
      imagePath: ["/images/hilux/versions/tc-sr/plata-met.png"],
      name: "Plata Metalico",
      priority: 3,
    },
    {
      ...
      imagePath: ["/images/hilux/versions/tc-sr/rojo-met.png"],
      name: "Rojo Metalico",
      priority: 4,
    },
    {
      ...
      imagePath: ["/images/hilux/versions/tc-sr/super-blanco.png"],
      name: "Súper Blanco",
      priority: 5,
    },
    // {
  ...
  const galleryData: ImageGalleryPreviewProps = {
    ...
    galleryLink:
      "/vehiculos/pick-ups/hilux/version/dc-sr-2-4diesel-4-x-4-mt/galeria",
    tabs: [
      {
        title: "Exterior",
        items: [
    ...
    <View position={isMobile ? "relative" : "static"}>
      ...
      <View position="relative">
        <BannerWithVideo
          slides={[
            {
              imageMobile: "/images/17-interna-del-vehiculo-hilux.png",
              imageDesktop: "/images/hilux/hero-banner/hero-banner.jpg",
              alt: "HILUX D.C. SR 2.4 DIÉSEL 4X4 MT",
            },
          ]}
          features={bannerFeatures}
          title="HILUX D.C. SR 2.4 DIÉSEL 4X4 MT"
          price="Desde   $215.900.000*"
        />
      </View>
