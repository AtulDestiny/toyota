...
export default function App() {
  ...
  const galleryData: ImageGalleryPreviewProps = {
    ...
    galleryLink:
      "/vehiculos/pick-ups/hilux/version/dc-srx-2-8diesel-4-x-4-at/galeria",
    tabs: [
      {
        title: "Exterior",
        items: [
  ...
  const vehicleNavigationData = {
    vehicleName: "Hilux D.C. SRX 2.8 DIÉSEL 4X4 AT",
    ...
    sections: [
      ...
      },
      {
        ...
        links: [
          {
            label: "Exterior",
            href: "/vehiculos/pick-ups/hilux/version/dc-srx-2-8diesel-4-x-4-at/galeria#exterior",
          },
          {
            label: "Interior",
            href: "/vehiculos/pick-ups/hilux/version/dc-srx-2-8diesel-4-x-4-at/galeria#interior",
          },
        ],
      },
          ...
          slides={[
            {
              ...
              alt: "HILUX D.C. SRX 2.8 DIÉSEL 4X4 AT",
            },
          ]}
          features={bannerFeatures}
          title="HILUX D.C. SRX 2.8 DIÉSEL 4X4 AT"
          price="Desde   $295.900.000*"
        />
      </View>
