...
const specsData = [
  ...
  },
  {
    name: "Confort",
    details:
      "BOLSAS DE AIRE: 7 RADIO: 9 con Android Auto Y Apple Carplay ESPEJOS EXTERIORES: Eléctricos",
  },
  {
    name: "Transmisión",
  ...
  {
    name: "Drivetrain",
    details: "TRACCIÓN 4WD PART TIME",
  },
];
...
export default function App() {
  ...
  const dummyColorsList: ColorOption[] = [
    {
      ...
      imagePath: ["/images/hilux/versions/tr-sr/gris-met.png"],
      name: "Gray Metálico",
      priority: 1,
    },
    {
      ...
      imagePath: ["/images/hilux/versions/tr-sr/plata-met.png"],
      name: "Plata Metálico",
      priority: 2,
    },
    {
      ...
      imagePath: ["/images/hilux/versions/tr-sr/super-lanco.png"],
      name: "Súper Blanco",
      priority: 3,
    },
  ];
  ...
  const galleryData: ImageGalleryPreviewProps = {
    ...
    galleryLink:
      "/vehiculos/pick-ups/hilux/version/dc-sr-2-7-4-x-4-gasolina-mt/galeria",
    tabs: [
      {
        title: "Exterior",
        items: [
  ...
  const vehicleNavigationData = {
    vehicleName: "HILUX D.C. SR 2.7 4X4 GASOLINA MT",
    ...
    sections: [
      ...
      },
      {
        ...
        links: [
          {
            label: "Exterior",
            href: "/vehiculos/pick-ups/hilux/version/dc-sr-2-7-4-x-4-gasolina-mt/galeria#exterior",
          },
          {
            label: "Interior",
            href: "/vehiculos/pick-ups/hilux/version/dc-sr-2-7-4-x-4-gasolina-mt/galeria#interior",
          },
        ],
      },
          ...
          slides={[
            {
              ...
              alt: "HILUX D.C. SR 2.7 4X4 GASOLINA MT",
            },
          ]}
          features={bannerFeatures}
          title="HILUX D.C. SR 2.7 4X4 GASOLINA MT"
          price="Desde  $195.500.000*"
        />
      </View>
