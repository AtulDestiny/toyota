...
const specsData = [
  ...
  },
  {
    name: "Confort",
    details:
      "TAPICERÍA: Cuero RADIO: 9 con Android Auto y Apple Carplay Encendido por botón",
  },
  {
    name: "Transmisión",
  ...
  },
  {
    name: "Suspensión",
    details:
      "DELANTERA: Doble horquilla con resortes helicoidales TRASERA: Eje rígido con ballestas",
  },
  {
    name: "Drivetrain",
...
export default function App() {
  ...
  const dummyColorsList: ColorOption[] = [
    {
      ...
      imagePath: ["/images/hilux/versions/tp-srv/attitude-black.png"],
      name: "Negro Mica",
      priority: 1,
    },
    {
      ...
      imagePath: ["/images/hilux/versions/tp-srv/blanco-perla.png"],
      name: "Blanco Perla",
      priority: 2,
    },
    {
      ...
      imagePath: ["/images/hilux/versions/tp-srv/gris-met.png"],
      name: "Gris Metálico",
      priority: 3,
    },
    {
      ...
      imagePath: ["/images/hilux/versions/tp-srv/rojo-met.png"],
      name: "Rojo Metálico",
      priority: 4,
    },
    {
      ...
      imagePath: ["/images/hilux/versions/tp-srv/super-blanco.png"],
      name: "Súper Blanco",
      priority: 5,
    },
  ];
  ...
  const galleryData: ImageGalleryPreviewProps = {
    ...
    galleryLink:
      "/vehiculos/pick-ups/hilux/version/dc-srv-2-4-diesel-4-x-4-at/galeria",
    tabs: [
      {
        title: "Exterior",
        items: [
          {
            src: "/images/hilux/exterior/exterior3.jpg",
            alt: "Título de la imagen",
          },
          {
            src: "/images/hilux/exterior/exterior4.jpg",
            alt: "Título de la imagen",
          },
          {
  ...
  const vehicleNavigationData = {
    vehicleName: "HILUX D.C. SRV 2.4 DIÉSEL 4X4 AT",
    ...
    sections: [
      ...
      },
      {
        ...
        links: [
          {
            label: "Exterior",
            href: "/vehiculos/pick-ups/hilux/version/dc-srv-2-4-diesel-4-x-4-at/galeria#exterior",
          },
          {
            label: "Interior",
            href: "/vehiculos/pick-ups/hilux/version/dc-srv-2-4-diesel-4-x-4-at/galeria#interior",
          },
        ],
      },
  ...
  return (
    <View position={isMobile ? "relative" : "static"}>
          ...
          slides={[
            {
              ...
              alt: "HILUX D.C. SRV 2.4 DIÉSEL 4X4 AT",
            },
          ]}
          features={bannerFeatures}
          title="HILUX D.C. SRV 2.4 DIÉSEL 4X4 AT"
          price="Desde   $257.500.000*"
        />
      </View>

      <VehicleShortcuts technicalSpecs="/images/pdf/FT_TOYOTA_HILUX.pdf" />
      ...
      >
        <SectionTitle
          title={"Fortuner SRV 2.4 Diésel 4x4 AT"}
          titleFontSize={{ base: "sm", xl: "md" }}
