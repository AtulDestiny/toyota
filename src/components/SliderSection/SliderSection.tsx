  ...
  return (
    ...
    >
      ...
      >
        ...
        <Flex className="swiper--slider-section" justifyContent={"center"}>
          <Swiper
            style={{ maxWidth: "min(1530px, 80%)", margin: "0 auto" }}
                  ...
                  {displayType === "card" ? (
                    ...
                    >
                      ...
                      >
                        ...
                        {item.primaryTitlePoints &&
                          item.primaryTitlePoints.length > 0 && (
                            <View
                              as="ul"
                              margin="20px 0"
                              padding="0 0 0 20px"
                            ...
                            >
                              {item.primaryTitlePoints.map((point, i) => (
                                <Flex
                                  key={`bullet-${i}`}
                                  direction="row"
                                  alignItems="center"
                        ...
                        {item.secondaryBulletPoints &&
                          item.secondaryBulletPoints.length > 0 && (
                            <View
                              as="ul"
                              margin="20px 0"
                              padding="0 0 0 20px"
                              style={{ listStyleType: "disc" }}
                            >
                              {item.secondaryBulletPoints.map((point, i) => (
                                <Flex
                                  key={`bullet-${i}`}
                                  direction="row"
                                  alignItems="center"
                    ...
                    <View
                      ...
                      backgroundColor={isMobile ? (Bgcolor ?? "#000") : "#000"}
                      padding={{
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              {item.image &&
                                (item.image.src || item.image?.desktopSrc) && (
                                  <Flex
                                    alignItems={"center"}
                                    position="relative"
                                    height={{
