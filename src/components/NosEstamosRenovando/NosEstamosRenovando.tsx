...
export const NosEstamosRenovando: React.FC<BlogDetailComponentProps> = (
  props
) => {
  const {
    slug,
  ...
  return (
    <View width="100%">
      ...
      >
        ...
        <Heading
          level={1}
          fontSize={{ base: "56px", medium: "56px", large: "56px" }}
          ...
          dynamicContent.detailImages.length > 0 && (
            ...
            >
              {dynamicContent.detailImages.map((image, index) => (
                <View key={index} width={{ base: "100%", medium: "48%" }}>
                  <Image
                    borderRadius={index === 0 ? { base: "50%" } : undefined}
                    src={image.src}
                    alt={image.alt}
                    width="100%"
                    height={{ base: "163px", medium: "556px" }}
                    objectFit="cover"
                  />
                </View>
              ))}
      ...
      {dynamicContent.galleryImages &&
        dynamicContent.galleryImages.length > 0 && (
          ...
          >
            ...
            <View
              position="relative"
              width={{ base: "100%", medium: "602px", large: "602px" }}
              height={{ base: "200px", medium: "340px", large: "340px" }}
              borderRadius="8px"
              margin="0 auto"
            >
              <Image
                src={
                  dynamicContent.galleryImages[currentSlide - 1]?.src ||
                  "/images/silver.svg"
                }
                alt={
                  dynamicContent.galleryImages[currentSlide - 1]?.alt ||
...
export default NosEstamosRenovando;
