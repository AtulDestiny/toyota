  ...
  Autos: [
    {
      id: 1,
      name: "Corolla",
      img: "/images/repuestos/corolla.png",
      link: "/servicios/posventa/marketplace?model=corolla",
    },
    {
      id: 2,
      name: "Yaris",
      img: "/images/repuestos/yaris.png",
      link: "/servicios/posventa/marketplace?model=Yaris",
    },
  ],
  Camionetas: [
    {
  ...
  "Pick Ups": [
    {
      id: 1,
      name: "Hilux",
      img: "/images/repuestos/hilux.png",
      link: "/servicios/posventa/marketplace?model=corolla",
    },
    {
      id: 1,
      name: "Tundra",
      img: "/images/repuestos/tundra.png",
      link: "/servicios/posventa/marketplace?model=tundra",
    },
  ],
  "Ver todos": [],
};
...
export default function CatalogoPostventaAccesorios({
  title,
  subtitle,
  description,
  type,
  ...
  const [vehicles, setVehicles] = useState<VehicleCardProps[]>(spareParts[tab]);
    ...
    `}
      ...
      <View>
        <CatalogoPostventaBanner
          slides={[
            {
              imageMobile: "/images/Banner-Accesorios-mobile.jpg",
              imageDesktop: "/images/Banner-Accesoriosdesktop.jpg",
              title: "",
              titleSecondLine: "",
        ...
        >
          ...
          <Tabs.Container
            defaultValue={tab}
            onValueChange={(value) => {
              const val = value as VehicleCategory;
              setTab(val);
              setVehicles(items[val] || []);
            }}
          >
            <View
              ...
              <Select
                ...
                selectedOption={
                  tab
                    ? {
                        value: tab,
                        label: tab === "Camionetas" ? "Camionetas y SUV" : tab,
                      }
                    : null
                }
                onSelect={(selected) => {
            ...
            >
              {(Object.keys(items) as VehicleCategory[]).map((category) => (
                <Tabs.Item
                  key={category}
                  value={category}
                  color="inherit"
                ...
                >
                  {category === "Camionetas" ? "Camionetas y SUV" : category}
                </Tabs.Item>
              ))}
            </Tabs.List>
            {(Object.keys(items) as VehicleCategory[]).map((category) => (
