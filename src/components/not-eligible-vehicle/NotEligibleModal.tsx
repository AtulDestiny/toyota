...
export const NotEligibleModal: React.FC<NotEligibleModalProps> = ({
  onClose,
  onRedirect,
  isInStepper = false,
}) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          La cobertura extendida T10 sólo es válida para modelos entregados a
          partir del año 2020 y con un kilometraje inferior o igual a 200,000 km
        </Text>
