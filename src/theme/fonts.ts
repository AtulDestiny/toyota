...
export const toyotaTypeRegular = localFont({
  variable: "--font-ToyotaType-Regular",
  src: [
    {
...
export const decimaMonoPro = localFont({
  variable: "--font-decimaMonoPro",
  src: [
    {
      path: "../../public/fonts/DecimaMonoPro.ttf",
      weight: "400",
      style: "normal",
    },
  ],
